...
| [043](backlog/043-backend-dcs-wcp-buka-ulang-dari-analyzed.md) | DCS/WCP terkunci **ANALYZED** (terminal) → tak bisa mulai data asli. Dua kebutuhan: (1) **data-ops** reset data uji coba 14 Jul; (2) **struktural** transisi `ANALYZED→OPEN`/endpoint reset. Risiko: K-Index DCS baca hasil WCP → reopen bikin stale | backend | **Butuh keputusan produk** (opsi a/b/c) + konfirmasi data-ops | — |
